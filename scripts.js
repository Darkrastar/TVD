...
function incorrecto(comp) {
    ...
    if (pos == 1 && id == "incorrecta-1") {
        vid.src = "incorrecta1-1.mp4"
        vid.play();
        hide();
    } else if (pos == 1 && id == "incorrecta-2") {
        vid.src = "incorrecta1-2.mp4"
        vid.play();
        hide();
    } else if (pos == 2 && id == "incorrecta-1") {
        vid.src = "incorrecta2-1.mp4"
        vid.play();
        hide();
    } else if (pos == 2 && id == "incorrecta-2") {
        vid.src = "incorrecta2-2.mp4"
        vid.play();
        hide();
    } else if (pos == 3 && id == "incorrecta-1") {
        vid.src = "incorrecta3-1.mp4"
        vid.play();
        hide();
    } else if (pos == 3 && id == "incorrecta-2") {
        vid.src = "incorrecta3-2.mp4"
        vid.play();
        hide();
    }
